...
1. Press the "Use template" button at the top of this repo to create a new repo with the contents of this bearer
2. Run "./configure-bearer.sh" to run a script that will replace all placeholders throughout all the files
...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/bearer.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/bearer)
...
```bash
php artisan vendor:publish --provider="Ryangjchandler\Bearer\BearerServiceProvider" --tag="bearer-migrations"
php artisan migrate
```

You can publish the config file with:
```bash
php artisan vendor:publish --provider="Ryangjchandler\Bearer\BearerServiceProvider" --tag="bearer-config"
```
